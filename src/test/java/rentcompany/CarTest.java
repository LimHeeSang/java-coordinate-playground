...
public class CarTest {
    ...
    void sonata_fuel_amount() {
        ...
        Assertions.assertThat(sonata.getFuelAmount()).isEqualTo(15D);
    }
    ...
    void avante_fuel_amount() {
        ...
        Assertions.assertThat(avante.getFuelAmount()).isEqualTo(10D);
    }
    ...
    void k5_fuel_amount() {
        K5 k5 = new K5(150);
        Assertions.assertThat(k5.getFuelAmount()).isEqualTo(11D);
    }
}
